...
def main():
    ...
    st.write("Aplikasi ini mengklasifikasikan suara menjadi Buka atau Tutup menggunakan model berbasis TSFEL dan MFCC.")
    ...
    if option == "Rekam Langsung":
        audio_bytes = audio_recorder(text="Klik untuk mulai/stop rekam")
        if audio_bytes:
